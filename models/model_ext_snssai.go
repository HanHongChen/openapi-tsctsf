...
type ExtSnssai struct {
	...
	SdRanges []SdRange `json:"sdRanges,omitempty" yaml:"sdRanges" bson:"sdRanges" mapstructure:"SdRanges"`
	...
	WildcardSd bool `json:"wildcardSd,omitempty" yaml:"wildcardSd" bson:"wildcardSd" mapstructure:"WildcardSd"`
}
