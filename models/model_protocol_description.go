...
type ProtocolDescription struct {
	TransportProto MediaTransportProto `json:"transportProto,omitempty" yaml:"transportProto" bson:"transportProto,omitempty"`
	RtpHeaderExtInfo *RtpHeaderExtInfo `json:"rtpHeaderExtInfo,omitempty" yaml:"rtpHeaderExtInfo" bson:"rtpHeaderExtInfo,omitempty"`
