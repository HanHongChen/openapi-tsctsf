...
type ProblemDetailsTsctsfQosTscac struct {
	...
	SupportedApiVersions []string `json:"supportedApiVersions,omitempty" yaml:"supportedApiVersions" bson:"supportedApiVersions,omitempty"`
