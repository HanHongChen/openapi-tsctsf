...
type ConfigForPort struct {
	...
	N6Ind bool `json:"n6Ind,omitempty" yaml:"n6Ind" bson:"n6Ind,omitempty"`
	PtpEnable bool `json:"ptpEnable,omitempty" yaml:"ptpEnable" bson:"ptpEnable,omitempty"`
	LogSyncInter int32 `json:"logSyncInter,omitempty" yaml:"logSyncInter" bson:"logSyncInter,omitempty"`
	LogSyncInterInd bool `json:"logSyncInterInd,omitempty" yaml:"logSyncInterInd" bson:"logSyncInterInd,omitempty"`
	LogAnnouInter int32 `json:"logAnnouInter,omitempty" yaml:"logAnnouInter" bson:"logAnnouInter,omitempty"`
