...
type ClockQualityAcceptanceCriterion struct {
	SynchronizationState []SynchronizationState `json:"synchronizationState,omitempty" yaml:"synchronizationState" bson:"synchronizationState,omitempty"`
	ClockQuality *ClockQuality `json:"clockQuality,omitempty" yaml:"clockQuality" bson:"clockQuality,omitempty"`
