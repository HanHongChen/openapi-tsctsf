...
type AcceptanceCriteriaResultIndication string

// List of AcceptanceCriteriaResultIndication
const (
        AcceptanceCriteriaResultIndication_ACCEPTABLE AcceptanceCriteriaResultIndication = "ACCEPTABLE"
        AcceptanceCriteriaResultIndication_NON_ACCEPTABLE AcceptanceCriteriaResultIndication = "NON_ACCEPTABLE"
)
