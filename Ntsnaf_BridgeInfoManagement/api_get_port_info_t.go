...
type BridgeInfoManagementGetPortPairInformationtApiService service

func (a *BridgeInfoManagementGetPortPairInformationtApiService) BridgeInfoManagementGetPortPairInformationt(ctx context.Context, bridgeid string) ([][]models.TsnBridgeCapability, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath() + "/GetActivePortInfo"
